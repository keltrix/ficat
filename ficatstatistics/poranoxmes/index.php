...
<body class="col s12 m12 l12">  
  ...
  <ul class="sidenav center-align" id="full-screen">
    ...
    <li class="active"><a>POR ANO X MÊS</a></li>
  ...
  <main>
          ...
          <div class="col s12 m12 l8 offset-l3">
            ...
            <div class="input-field col s12 l3 m4">
              ...
              <select name="mesSelect" id="mesSelect">
                <option value="<?php echo $mes; ?>" selected><?php echo $nome_mes; ?></option>
    ...
    <form method="POST" action="../relatorios/relatorioporanoxmes.php" target="_blank">
      <!-- //Estrutura com grid responsivo de coluna com centralização em mobile e desktop. -->
      <div class="col s12 m12 l12">
        ...
        <div class="hide input-field col s12 l4 m4">
          <!-- //Select com os possiveis anos de buscar -->
          <select >
            <option name="imgUrl" id="imgUrl" selected><?php echo $ano; ?></option>
          </select>
          <label>Selecione o Ano</label>
        </div>
        ...
        <?php
        if (isset($_POST["anoSelect"]) && isset($_POST["mesSelect"])) { 
          echo '<div class="input-field col s12 l4 m2 center-align">
