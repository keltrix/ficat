  ...
  $(function () { 
    var myChart = Highcharts.chart('container', {
      ...
      series: [{
        ...
        name: 'Núcleo de Ciências Agrárias e Desenvolvimento Rural',
        data: [<?php echo join($ncadr, ',') ?>]
      }, {
        name: 'Núcleo de Desenvolvimento Amazônico em Engenharia',
        data: [<?php echo join($ndae, ',') ?>]
      }, {
        name: 'Núcleo de Estudos Transdisciplinares em Educação Básica',
        data: [<?php echo join($neb, ',') ?>]
      }, {
        name: 'Núcleo de Inovação e Tecnologias Aplicadas a Ensino e Extensão',
        data: [<?php echo join($nitae, ',') ?>]
      }, {
        name: 'Núcleo de Medicina Tropical',
        data: [<?php echo join($nmt, ',') ?>]
      }, {
        name: 'Núcleo de Pesquisas em Oncologia',
        data: [<?php echo join($npo, ',') ?>]
      }, {
        name: 'Núcleo de Teoria e Pesquisa do Comportamento',
        data: [<?php echo join($ntpc, ',') ?>]
      }, {
        name: 'Núcleo do Meio Ambiente',
        data: [<?php echo join($numa, ',') ?>]
      }]
    });
  });
</script>